...
@Component({
  selector: 'app-manager-j',
  templateUrl: './manager-j.component.html',
  styleUrls: ['./manager-j.component.css']
})
export class ManagerJComponent {
  ...
  ngOnInit(){
    this.service.getAllComplaintsManagerJ().subscribe(ob=>this.complaints=ob);
  }
