...
@Component({
  selector: 'app-manager-b',
  templateUrl: './manager-b.component.html',
  styleUrls: ['./manager-b.component.css']
})
export class ManagerBComponent {
  ...
  ngOnInit(){
    this.service.getAllComplaintsManagerB().subscribe(ob=>this.complaints=ob);
  }
