...
@Component({
  selector: 'app-manager-e',
  templateUrl: './manager-e.component.html',
  styleUrls: ['./manager-e.component.css']
})
export class ManagerEComponent {
  ...
  ngOnInit(){
    this.service.getAllComplaintsManagerE().subscribe(ob=>this.complaints=ob);
  }
