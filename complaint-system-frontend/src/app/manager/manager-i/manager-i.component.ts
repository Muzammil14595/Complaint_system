...
@Component({
  selector: 'app-manager-i',
  templateUrl: './manager-i.component.html',
  styleUrls: ['./manager-i.component.css']
})
export class ManagerIComponent {
  ...
  ngOnInit(){
    this.service.getAllComplaintsManagerI().subscribe(ob=>this.complaints=ob);
  }
