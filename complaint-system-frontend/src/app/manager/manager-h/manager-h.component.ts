...
@Component({
  selector: 'app-manager-h',
  templateUrl: './manager-h.component.html',
  styleUrls: ['./manager-h.component.css']
})
export class ManagerHComponent {
  ...
  ngOnInit(){
    this.service.getAllComplaintsManagerH().subscribe(ob=>this.complaints=ob);
  }
