...
@Component({
  selector: 'app-manager-c',
  templateUrl: './manager-c.component.html',
  styleUrls: ['./manager-c.component.css']
})
export class ManagerCComponent {
  ...
  ngOnInit(){
    this.service.getAllComplaintsManagerC().subscribe(ob=>this.complaints=ob);
  }
