...
@Component({
  selector: 'app-manager-a',
  templateUrl: './manager-a.component.html',
  styleUrls: ['./manager-a.component.css']
})
export class ManagerAComponent {
  ...
  ngOnInit(){
    this.service.getAllComplaintsManagerA().subscribe(ob=>this.complaints=ob);
  }
